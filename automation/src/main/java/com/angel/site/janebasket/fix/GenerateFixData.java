package com.angel.site.janebasket.fix;
...
public class GenerateFixData extends GenerateFile {
	...
	public void fixEmptyId(String resourceFile) throws Exception {
		...
		String unionFile = folderUtil.combineDic( folderUtil.calRootPath(), "wanglin/janebasket", "union.json");
	...
	public void fixUnion(String resourceFile) throws Exception {
		...
		while (iter.hasNext()) {
		    ...
		    clothItem = unionMap.get(entry.getKey());
