...
public class Generate5Import extends GenerateFile {
	...
	private void prepareTab(Map<String, ClothItem> mapResource, List<String[]> subTabImage,
		...
		while (it.hasNext()) {
			...
			if (clothItem.getImageSrcList() != null && clothItem.getImageSrcList().size() >= 0) {
				for (int k = 0; k < clothItem.getImageSrcList().size(); k++) {
					// save to sub tab;
	...
	public static void main(String[] args) throws Exception {
		...
		Generate5Import me = new Generate5Import();
