...
public class Generate7Price extends GenerateFile {
	...
	private void doit(String resourceFile) throws Exception {
		...
		driver.findElement(By.name("custNum")).sendKeys("29967");
		driver.findElement(By.name("email")).sendKeys("lin@linsmart.com");
		driver.findElement(By.name("psswrd")).sendKeys("bntp016");
